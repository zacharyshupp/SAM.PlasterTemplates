<#
	.SYNOPSIS
		Module Build wrapper for <%=$PLASTER_PARAM_ModuleName%>

	.NOTES
		Change Log:
			1.0.0 - <%=$PLASTER_Date%> (Zachary Shupp)

	.LINK
		https://github.com/zacharyshupp/<%=$PLASTER_PARAM_ModuleName%>
#>
...
$moduleParams = @{
	...
	ProjectUri       = "https://github.com/zacharyshupp/<%=$PLASTER_PARAM_ModuleName%>"
	LicenseUri       = "https://github.com/zacharyshupp/<%=$PLASTER_PARAM_ModuleName%>/blob/main/LICENSE.md"
	Tags             = @('SAM', 'Plaster', 'Templates')
	FormatsToProcess = @()
}
